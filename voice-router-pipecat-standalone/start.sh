...
export VOICE_ROUTER_INPUT_DEVICE_MATCH="${VOICE_ROUTER_INPUT_DEVICE_MATCH:-USB Composite Device,USB Audio}"
export VOICE_ROUTER_INPUT_DEVICE_EXCLUDE="${VOICE_ROUTER_INPUT_DEVICE_EXCLUDE:-hdmi,nvidia,monitor,spdif}"
